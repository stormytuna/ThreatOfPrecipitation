...
// https://github.com/tModLoader/tModLoader/blob/1.4/ExampleMod/Content/NPCs/Worm.cs
...
namespace ThreatOfPrecipitation.Content.NPCs
{
	...
	public abstract class Worm : ModNPC
	{
		...
		internal bool CheckCollision(bool makeDust = false)
		{
	...
	public abstract class WormHead : Worm
	{
		...
		internal sealed override void HeadAI()
		{
			...
			bool collision = CheckCollision(true);
