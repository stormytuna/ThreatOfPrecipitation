...
namespace ThreatOfPrecipitation.Content.Tiles.Furniture
{
    public class BossRelic : ModTile
    {
        ...
        public string RelicTextureName => "ThreatOfPrecipitation/Content/Tiles/Furniture/BossRelics";

        public override string Texture => "ThreatOfPrecipitation/Content/Tiles/Furniture/RelicPedestal";
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            {
                case 0:
                    itemType = ModContent.ItemType<MagmaWormRelic>();
                    break;
                // Add mnore cases here when more boss relics are created
            }
